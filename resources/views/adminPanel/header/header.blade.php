...
<ul class="app-nav">
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu settings-menu dropdown-menu-right">
			<li><a class="dropdown-item" href="page-user.html"><i class="fa fa-cog fa-lg"></i> {{__('general.settings')}}</a></li>
            <li><a class="dropdown-item" href="{!! route('adminLogout') !!}" ><i class="fa fa-sign-out fa-lg"></i> {{__('general.logout')}}</a></li>
		</ul>
	</li>
</ul>
@endsection
